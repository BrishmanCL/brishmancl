...
const listProducts = [
    {
        title: "WhatsCampaign",
        description: "Realiza campañas de whatsapp con la IA"
    },
    {
        title: "WhatsBot",
        description: "Automatiza el proceso de tus atenciones hacia tus clientes"
    },
    {
        title: "Punto de Venta",
        description: "Tus facturas y boletas en segundos, tu efectivo  y stock siempre al día."
    }
]

function ElementProductos({ title, description }: { title: string, description: string }) {
    return (
        <div className="group relative flex items-center gap-x-6 rounded-lg p-4 text-lg/6 hover:bg-gray-50">
            ...
            <div className="flex-auto">
                ...
                <p className="mt-1 text-gray-600 text-base/4">{description}</p>
            </div>
        </div>
    );
}
        ...
        <header className="">
            <nav className="flex mx-4 sm:mx-8 md:mx-10 xl:mx-36 2xl:mx-96 items-center justify-between py-6 lg:py-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <a href="#servicios" className="text-lg/6 font-semibold text-slate-700">Servicios</a>
                    {/*
                    <div className="relative">
                        <button onMouseOver={toggleMenu} type="button" className="flex items-center gap-x-1 text-lg/6 font-semibold text-slate-700" aria-expanded="false">
                            Productos
                        ...
                        {isOpen && (
                            <div className="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-gray-900/5">
                                <div className="p-4">
                                    {
                                        listProducts.map(i => (
                                            <ElementProductos title={i.title} description={i.description} />
                                        ))
                                    }
                    ...
                    */}
                    <a href="#clientes" className="text-lg/6 font-semibold text-slate-700">Clientes</a>
                    <a href="#contacto" className="text-lg/6 font-semibold text-slate-700">Contacto</a>
                </div>
                
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#contacto" className="text-lg/6 font-semibold text-[#003697]">Agendar <span aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
            {isMobileMenuOpen && (
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-6">
                                    <a href="#servicios" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Servicios</a>
                                    {/* 
                                    <div className="-mx-3">
                                    ...
                                    */}
                                    <a href="#clientes" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Clientes</a>
                                    <a href="#contacto" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Contacto</a>
                                </div>
                                <div className="py-6">
                                    <a href="#contacto" className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Agendar</a>
                                </div>
                            </div>
                        </div>
                    </div>
