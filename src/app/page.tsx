          ...
          <div className="h-full flex items-center flex-col-reverse gap-4 xl:gap-8 lg:flex-row ">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <h1 className="text-balance text-slate-700 text-4xl xl:text-5xl font-extrabold tracking-tight">
                ...
                Creamos experiencias digitales que convierten visitas en ventas.
              </h1>
      ...
      <div>
        <Wrapper>
          ...
          the URL, e.g. /search?query=abc */}
                    ...
                    <button
                      className="block lg:mx-0 mx-auto mt-4 focus:outline-none active:-translate-y-2 transition-all duration-300 shadow-lg hover:shadow-blue-500/50 bg-blue-950 hover:bg-transparent hover:text-blue-950 text-white p-2 pt-1 border-2 border-blue-950 rounded-lg font-semibold"
                      type="submit"
                    >
                      ¡Estamos en contacto!
                    </button>
